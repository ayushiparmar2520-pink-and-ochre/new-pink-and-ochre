...
export default function AboutPage() {
  ...
  const faqs = [
    {
      question: 'What is Pink & Ochre?',
      answer: 'Pink & Ochre is an independent women\'s lifestyle blog covering six categories: lifestyle, fashion, beauty, food, wellness, and books. It is written and edited by founder Aayushi Parmar.',
    },
    {
      question: 'Who writes for Pink & Ochre?',
    ...
    {
      question: 'What kind of content does Pink & Ochre publish?',
    ...
    {
      question: 'How can I collaborate with Pink & Ochre?',
    ...
    },
    {
      ...
      answer: 'The easiest way is to subscribe to the newsletter or follow Pink & Ochre on Instagram and Pinterest.',
    },
  ]
    ...
    <>
      ...
      <section className="py-20 md:py-28 bg-ivory">
        <div className="section-container">
          ...
          <h1 className="heading-large mt-4 mb-6">About Pink & Ochre</h1>
      ...
      <section className="py-20 md:py-28 bg-cream">
        <div className="section-container max-w-3xl">
          <div className="mb-16 pb-8 border-b border-warm-stone">
            ...
            <h2 className="heading-medium mt-4">What is Pink & Ochre?</h2>
          </div>

          <div className="prose prose-lg max-w-none space-y-6 text-taupe font-body leading-relaxed">
            <p>
              Founded by <strong>Aayushi Parmar</strong>, a digital marketer turned full-time lifestyle writer, Pink & Ochre is your everyday guide to dressing better, glowing brighter, eating smarter, feeling stronger, and reading deeper. Every post is researched, tested, and written to help you make small, joyful upgrades to the way you live.
            </p>
            <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-taupe leading-relaxed text-lg font-body">
                I'm a digital marketer with a big passion for all things lifestyle, and the writer behind every post on Pink & Ochre.
              </p>

              <p className="text-taupe leading-relaxed text-lg font-body">
                Pink & Ochre is my little corner of the internet, where I share my favorite things: outfit ideas, skincare routines, beauty rituals, easy and delicious recipes, wellness habits, the books I can't stop talking about, and small everyday tips for living your best life.
              </p>

              <p className="text-taupe leading-relaxed text-lg font-body">
                I truly believe life is a beautiful journey worth celebrating. My goal here is simple — to inspire you to embrace every moment, find your unique style, and take care of your well-being inside and out. Pink & Ochre is built as a warm, friendly community where we can all discover the art of living well, together.
              </p>
      ...
      <section className="py-20 md:py-28 bg-cream">
        <div className="section-container">
          <div className="mb-16 pb-8 border-b border-warm-stone">
            ...
            <h2 className="heading-medium mt-4">What You'll Find on Pink & Ochre</h2>
