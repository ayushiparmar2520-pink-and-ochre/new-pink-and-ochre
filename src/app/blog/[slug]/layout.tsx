...
const metaData: Record<string, ArticleMeta> = {
  ...
  'it-ends-with-us-book-review': {
    title: 'It Ends With Us by Colleen Hoover: An Honest Book Review (Is It Worth the Hype?) | Pink & Ochre',
    description: "Is It Ends With Us worth the hype? An honest, heartfelt review of Colleen Hoover's most important novel — the writing, the ending, and why this book changes you.",
  ...
  'books-like-devil-wears-prada': {
    title: 'Books Like The Devil Wears Prada: 10 Addictive Reads for Fans of Fashion, Ambition & Drama | Pink & Ochre',
    description: 'Loved The Devil Wears Prada — or just saw the new movie? These 10 books have the same fashion world glamour, sharp female ambition, and addictive drama.',
