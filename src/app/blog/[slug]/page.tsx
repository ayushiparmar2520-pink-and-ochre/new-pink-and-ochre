  ...
  'greek-yogurt-banana-bread': {
    ...
    content: `
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:1.2rem;margin:1.6rem 0;">
        <div style="background:#FDF5EC;border-radius:12px;padding:1.4rem;"><p style="margin:0 0 .5rem;font-family:'Playfair Display',serif;font-size:1.1rem;font-weight:600;color:#2C2018;">Chocolate Chip Greek Yogurt Banana Bread</p><p style="margin:0;color:#46403a;font-size:.95rem;line-height:1.6;">Fold ½ cup dark chocolate chips into the batter, then press a few extras on top before baking for that bakery look.</p><img src="/images/blog/greek-yogurt-banana-bread-chocolate-pecan.webp" alt="Banana bread loaf with chocolate chips and pecan halves on top, sliced to show moist crumb, overripe bananas in background, moody natural light" loading="lazy" style="width:100%;border-radius:12px;aspect-ratio:4/3;object-fit:cover;margin-top:.9rem;display:block;" /></div>
        <div style="background:#FDF5EC;border-radius:12px;padding:1.4rem;"><p style="margin:0 0 .5rem;font-family:'Playfair Display',serif;font-size:1.1rem;font-weight:600;color:#2C2018;">High-Protein Version</p><p style="margin:0;color:#46403a;font-size:.95rem;line-height:1.6;">Replace ¼ cup of the flour with unflavoured protein powder, and add an extra tablespoon of yogurt so the crumb stays moist.</p></div>
        <div style="background:#FDF5EC;border-radius:12px;padding:1.4rem;"><p style="margin:0 0 .5rem;font-family:'Playfair Display',serif;font-size:1.1rem;font-weight:600;color:#2C2018;">Walnut and Honey Version</p><p style="margin:0;color:#46403a;font-size:.95rem;line-height:1.6;">Fold in ½ cup chopped walnuts and drizzle honey over the top just before baking for a crackly, golden finish.</p><img src="/images/blog/greek-yogurt-banana-bread-walnut-sliced.webp" alt="Sliced banana walnut bread on a wooden cutting board with dried banana slices on top, walnuts scattered around, jar of caramel in background" loading="lazy" style="width:100%;border-radius:12px;aspect-ratio:4/3;object-fit:cover;margin-top:.9rem;display:block;" /></div>
        <div style="background:#FDF5EC;border-radius:12px;padding:1.4rem;"><p style="margin:0 0 .5rem;font-family:'Playfair Display',serif;font-size:1.1rem;font-weight:600;color:#2C2018;">Gluten-Free Version</p><p style="margin:0;color:#46403a;font-size:.95rem;line-height:1.6;">Swap in a 1:1 gluten-free baking flour blend with xanthan gum. Do not use almond flour alone — the loaf will not hold its structure.</p></div>
      </div>
